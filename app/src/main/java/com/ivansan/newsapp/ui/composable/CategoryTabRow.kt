...
Column() {
    ...
    LazyColumn(
        ...
        when(state){
            ...
            1 -> topNews?.let{itemsIndexed(topNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
            ...
            2 -> sportNews?.let{itemsIndexed(sportNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
            ...
            3 -> businessNews?.let{itemsIndexed(businessNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
            ...
            4 -> entertainmentNews?.let{itemsIndexed(entertainmentNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
            ...
            5 -> healthNews?.let{itemsIndexed(healthNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
            ...
            6 -> technologyNews?.let{itemsIndexed(technologyNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
            ...
            7 -> foodNews?.let{itemsIndexed(foodNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
            ...
            8 -> politicsNews?.let{itemsIndexed(politicsNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
            ...
            9 -> worldNews?.let{itemsIndexed(worldNews!!){ _, item ->
                NewsListItem(
                    item = item,
                    navController,
                    sharedViewModel
